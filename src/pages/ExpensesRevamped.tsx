...
const ExpensesRevamped = () => {
  ...
  // Common payment methods - matching the Expense interface
  const paymentMethods: Array<'cash' | 'card' | 'bank_transfer' | 'upi' | 'cheque' | 'online'> = [
    'cash',
    'card',
    'bank_transfer',
    'upi',
          ...
          <form onSubmit={handleSubmit(data => editingExpenseId ? handleUpdateExpense(editingExpenseId, data) : handleAddExpense(data))}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  onValueChange={(value) => setValue("paymentMethod", value as 'cash' | 'card' | 'bank_transfer' | 'upi' | 'cheque' | 'online')}
